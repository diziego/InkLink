          ...
          <div className="w-full max-w-lg text-center">
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              ...
              <form action={chooseRoleAction}>
                ...
                <button
                  type="submit"
                  className="group w-full rounded-xl border border-zinc-200 bg-white p-6 text-left shadow-sm transition hover:border-zinc-400 hover:shadow-md active:scale-[0.98]"
                >
                  <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-100 text-lg transition group-hover:bg-zinc-950 group-hover:text-white">
                    🖨
                  </div>
