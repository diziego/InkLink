      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex min-h-[60vh] items-center justify-center py-14">
          <div className="w-full max-w-md">
            ...
            <div className="mt-6 flex rounded-lg border border-zinc-200 bg-zinc-100 p-1">
              <Link
                href="/login"
            ...
            {mode === "magic" && (
              <>
                ...
                {sent ? (
                  ...
                  <form action={sendMagicLinkAction} className="mt-6">
                    <label
                      htmlFor="email"
            ...
            {mode === "password" && (
              <>
                <form action={signInWithPasswordAction} className="mt-6 grid gap-4">
                  ...
                  <button
                    type="submit"
                    className="h-11 w-full rounded-md bg-zinc-950 text-sm font-medium text-white transition hover:bg-zinc-800 active:bg-zinc-700"
                  >
                    Sign in
                  </button>
                </form>
