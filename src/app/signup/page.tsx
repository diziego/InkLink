        ...
        <div className="flex min-h-[60vh] items-center justify-center py-14">
          <div className="w-full max-w-md">
            ...
            {sent ? (
              ...
              <form action={signUpWithPasswordAction} className="mt-8 grid gap-4">
                <label
                  htmlFor="email"
                ...
                <button
                  type="submit"
                  className="mt-2 h-11 w-full rounded-md bg-zinc-950 text-sm font-medium text-white transition hover:bg-zinc-800 active:bg-zinc-700"
                >
                  Create account
                </button>
              </form>
